...
//        }
    ...
    private void DrawAdsSettings()
    {
        ...
        if (_adsSettings.isExpanded)
        {
            ...
            //_adsSettings.DrawChildrenDefault(nameof(AdsSettings.minAndMaxGameOversBetweenInterstitialAds)
            //, nameof(AdsSettings.minAndMaxGameOversBetweenInterstitialAds));
